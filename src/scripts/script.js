...
function calc() {
    ...
    const diaTraba = document.getElementById("diaTrabalhado").value;
    ...
    if(tempDeTrabInMin > 480){
        ...
        document.getElementById("resp").innerHTML += (`Ganho no dia R$${ganhoPorMinHRE}<br/>`);
        document.getElementById("resp").innerHTML += (`Dia: ${diaTraba}`);
    } else{
        document.getElementById("resp").innerHTML = (`Horas Trabalhadas: ${hrsTransf.toString().padStart(2, '0')}:${tranfHrToMin.toString().padStart(2, '0')}<br/>`);
        document.getElementById("resp").innerHTML += (`Ganho no dia R$${ganhoPorMin}<br/>`);
        document.getElementById("resp").innerHTML += (`Dia: ${diaTraba}`);
    }
